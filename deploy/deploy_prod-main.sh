...
api_server_base_url="https://api.myapp.myappdomain.com"
cloudfront_distribution_id="E3TDM7MGWEED1K"
...
notify_slack "[deploy] ${tf_env} (branch: main, commit: ${COMMIT_HASH}${options})"
