...
export type ScheduledJobWhereInput = {
  ...
  intervalSec?: Prisma.IntFilter<"ScheduledJob"> | number
  lastStartedAt?: Prisma.DateTimeNullableFilter<"ScheduledJob"> | Date | string | null
  lastEndedAt?: Prisma.DateTimeNullableFilter<"ScheduledJob"> | Date | string | null
  lastStatus?: Prisma.StringNullableFilter<"ScheduledJob"> | string | null
}
...
export type ScheduledJobOrderByWithRelationInput = {
  ...
  lastEndedAt?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type ScheduledJobScalarWhereWithAggregatesInput = {
  ...
  intervalSec?: Prisma.IntWithAggregatesFilter<"ScheduledJob"> | number
  lastStartedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"ScheduledJob"> | Date | string | null
  lastEndedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"ScheduledJob"> | Date | string | null
  lastStatus?: Prisma.StringNullableWithAggregatesFilter<"ScheduledJob"> | string | null
}
...
export type ScheduledJobUpdateInput = {
  ...
  lastEndedAt?: Prisma.NullableDateTimeFieldUpdateOperationsInput | Date | string | null
...
export type ScheduledJobOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"name" | "createdAt" | "updatedAt" | "nextRunAt" | "intervalSec" | "lastStartedAt" | "lastEndedAt" | "lastStatus", ExtArgs["result"]["scheduledJob"]>
...
export interface ScheduledJobDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const scheduledJobWithNameOnly = await prisma.scheduledJob.findMany({ select: { name: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ScheduledJobs and only return the `name`
   * const scheduledJobWithNameOnly = await prisma.scheduledJob.createManyAndReturn({
   *   select: { name: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ScheduledJobs and only return the `name`
   * const scheduledJobWithNameOnly = await prisma.scheduledJob.updateManyAndReturn({
   *   select: { name: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ScheduledJobFieldRefs {
  ...
  readonly intervalSec: Prisma.FieldRef<"ScheduledJob", 'Int'>
  readonly lastStartedAt: Prisma.FieldRef<"ScheduledJob", 'DateTime'>
  readonly lastEndedAt: Prisma.FieldRef<"ScheduledJob", 'DateTime'>
  readonly lastStatus: Prisma.FieldRef<"ScheduledJob", 'String'>
}
